...
s.homepage     = "https://github.com/wangxiangzhao/BaseProject"
  ...
  s.author       = { "wxz" => "13269532539@163.com" }
  ...
  s.homepage     = "http://EXAMPLE/BaseProject"
  ...
  # Or just: s.author    = "wangxiangzhao"
  # s.authors            = { "wangxiangzhao" => "13269532539@163.com" }
  # s.social_media_url   = "http://twitter.com/wangxiangzhao"
  ...
  s.source       = { :git => "http://EXAMPLE/BaseProject.git", :tag => "#{s.version}" }
